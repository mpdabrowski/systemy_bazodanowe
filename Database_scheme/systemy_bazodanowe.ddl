...
ALTER TABLE order_has_product ADD CONSTRAINT Relation_5_PK PRIMARY KEY CLUSTERED (order_id_order, product_id_product)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
CREATE TABLE order_status_history 
    (
     id_order_status_history BIGINT NOT NULL , 
     created_at DATETIME NOT NULL , 
     order_id_order BIGINT NOT NULL , 
...
CREATE TABLE order_status_translation 
    (
     id_order_status_translation BIGINT NOT NULL , 
